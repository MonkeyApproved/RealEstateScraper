...
source = requests.get('https://www.xe.gr/property/results?transaction_name=buy&item_type=re_residence&geo_place_id=ChIJ8UNwBh-9oRQR3Y1mdkU1Nic&maximum_price=150000&minimum_construction_year=2000&minimum_level=L1&minimum_size=70').text
# source for pagkrati
# source = requests.get('https://www.xe.gr/property/results?geo_place_id=ChIJy1stSUK9oRQRi9ObJcOmO20&item_type=re_residence&maximum_price=150000&minimum_construction_year=2000&minimum_level=L1&minimum_size=70&transaction_name=buy').text
